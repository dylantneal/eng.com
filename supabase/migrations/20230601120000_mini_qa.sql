...
*******************************/
-- Only create if not already exists from comprehensive schema fix
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'comment_votes') THEN
