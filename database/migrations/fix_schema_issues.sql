...
SET 
  ...
  preferences = COALESCE(preferences, '{"theme": "dark", "email_notifications": true}'::jsonb),
...
-- Versions table (some parts of app expect this)
...
-- ============================================================================
-- STEP 10: INSERT DEFAULT COMMUNITIES
-- ============================================================================

INSERT INTO public.communities (name, display_name, description, category, color) VALUES
  ('mechanical-engineering', 'Mechanical Engineering', 'Design, analysis, and manufacturing of mechanical systems', 'engineering', '#DC2626'),
  ('electronics', 'Electronics & PCB Design', 'Circuit design, PCB layout, and electronic prototyping', 'engineering', '#7C3AED'),
  ('robotics', 'Robotics', 'Autonomous systems, control theory, and robot design', 'engineering', '#059669'),
  ('software', 'Engineering Software', 'CAD, simulation, and engineering tools', 'software', '#2563EB'),
  ('materials', 'Materials Science', 'Material properties, testing, and selection', 'science', '#B45309'),
  ('manufacturing', 'Manufacturing', '3D printing, CNC, injection molding, and production', 'manufacturing', '#DC2626')
